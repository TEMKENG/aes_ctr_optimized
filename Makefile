all:
	clear && rm -rf data/test_coded.hex && cargo run  -- -c encrypt -i data/to_cipher/test_2gb.txt -v 00112233445566778899aabbccddeeff -k 000102030405060708090a0b0c0d0e0f -o data/test_coded.hex > data/output.log
